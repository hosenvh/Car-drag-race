...
namespace RTLTMPro
{
    public static class LigatureFixer
    {
        ...
        /// </summary>
        public static void Fix(FastStringBuilder input, FastStringBuilder output,TMP_FontAsset fontAsset, bool farsi, bool fixTextTags, bool preserveNumbers)
        {
            ...
            for (int i = input.Length - 1; i >= 0; i--)
            {
                ...
                {
                    if (fontAsset.HasCharacter(characterAtThisIndex))
                        LtrTextHolder.Add(characterAtThisIndex);
                    continue;
                }
