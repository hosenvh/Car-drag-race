...
public class ShowRoomScrollerController : CarouselScrollerController
{
    private ICarSimpleSpec[] m_cars;
    [SerializeField] private float m_cellViewSize = 190;
    ...
    public string SelectedID
    {
        ...
        set
        {
            if (m_cars != null)
            {
                SelectedIndex = Array.IndexOf(m_cars, value)+m_startDummyObjectCount;
            }
        }
    }
